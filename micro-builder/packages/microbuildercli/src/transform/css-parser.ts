    ...
    // Start of a string.
      ...
      for (let j = i + 1; j < input.length; j++) {
        ...
        // ```
          ...
          throw new Error(
            `Unterminated string: ${
              input.slice(start, j + 1) + String.fromCharCode(currentChar)
            }`
          );
        }
        ...
        // ```
          ...
          throw new Error(
            `Unterminated string: ${
              input.slice(start, j) + String.fromCharCode(currentChar)
            }`
          );
        }
      }
          ...
          if (parent) {
            ...
            parent.nodes.push({
              ...
              value: buffer
                .slice(
                  colonIdx + 1,
                  importantIdx === -1 ? buffer.length : importantIdx
                )
                .trim(),
